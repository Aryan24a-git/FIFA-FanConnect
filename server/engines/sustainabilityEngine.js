...
function getEcoRecommendation(stadiumId, transportMode, distanceKm = 15) {
  ...
  return {
    ...
    wasteSorting: [
      { type: 'Recyclable Cups', instruction: 'Place in designated green bins located at all exit portals.' },
      { type: 'Compostables', instruction: 'Dispose of organic waste at brown bin stations near food courts.' },
      { type: 'General Landfill', instruction: 'Minimize landfill waste by using reusable containers.' }
    ],
